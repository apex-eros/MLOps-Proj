...
# Setup Jinja2 templates engine for rendering HTML Templates
templates = Jinja2Templates(directory='templates')

# Allow all origins for Cross-Origin Resource sharing (CORS)
origins = ["*"]

# COnfigure middleware to handle CORS, allowing requests from any origins
...
async def predictRouteClient(request : Request):
    ...
    try:
        ...
        # Convert form data into a DF for the model
...
if __name__ == "__main__":
    app_run("app:app", host=APP_HOST, port=APP_PORT, reload=True)
